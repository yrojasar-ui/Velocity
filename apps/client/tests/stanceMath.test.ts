  ...
  it.each([
    {
      ...
      movementRequiresCrouchedStance: false,
      physicallyCrouched: true,
      crouchHeld: true,
      standClear: true,
      acceptedLowProfileJump: false,
      expected: true,
    },
    {
    ...
    },
    {
      ...
      movementRequiresCrouchedStance: true,
      physicallyCrouched: true,
      crouchHeld: true,
      standClear: false,
      acceptedLowProfileJump: false,
    ...
    {
      name: "uses the crouched stance while Slide is active",
      movementRequiresCrouchedStance: true,
      physicallyCrouched: false,
      crouchHeld: true,
      standClear: true,
    ...
    expect(
      isPhysicalCrouchRequired(
        input.movementRequiresCrouchedStance,
        input.physicallyCrouched,
        input.crouchHeld,
        input.standClear,
        input.acceptedLowProfileJump,
      ),
    ).toBe(expected);
  });
});
